...
def image_to_data(image):
    """Generator function to convert a PIL image to 8-bit RGB332 bytes.

    Output layout: ``RRRGGGBB`` per pixel. File size = width * height bytes.
    """
    ...
    # RRR GGG BB packed into one byte per pixel.
    color = r | g | b
